...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 byte[] hashBytes = hash.SHA512(inputBytes);
//                 timer.Stop();
...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 byte[] hashBytes = hash.SHA256(inputBytes);
//                 timer.Stop();
...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 byte[] hashBytes = hash.SHA1(inputBytes);
//                 timer.Stop();
...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 byte[] hashBytes = hash.MD5(inputBytes);
//                 timer.Stop();
...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 uint fnv32 = hash.FNV32(inputBytes);
//                 timer.Stop();
...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 uint crc32 = hash.CRC32(inputBytes);
//                 timer.Stop();
...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 string fletcher64 = Convert.ToHexString(hash.Fletcher(inputBytes, 64));
//                 timer.Stop();
...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 string fletcher32 = Convert.ToHexString(hash.Fletcher(inputBytes, 32));
//                 timer.Stop();
...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 string fletcher16 = Convert.ToHexString(hash.Fletcher(inputBytes, 16));
//                 timer.Stop();
...
//                 var timer = System.Diagnostics.Stopwatch.StartNew();
//                 uint adler32 = hash.Adler32(inputBytes);
//                 timer.Stop();
